...
Tárgykatalógus. Minden tárgy oldala tartalmazza a hozzá tartozó fogalomlapok teljes, témák szerint csoportosított listáját — a fogalmak itt szándékosan nincsenek külön felsorolva.

Kereséshez: `qmd query "kérdés" -c wiki`.

## Subjects

| Tárgy                         | Lapok | Tartalom                                                                                                                                                                                  |
| ----------------------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [[subjects/analii]]           | 49    | Analízis II.: differenciálszámítás, Taylor-sorok, határozott/határozatlan és improprius integrál, geometriai alkalmazások                                                                 |
| [[subjects/analiii]]          | 125   | Analízis III.: metrikus és normált terek topológiája, Jordan-mérték és többszörös integrál, vonal- és felületi integrálok, Green-, Gauss–Osztrogradszkij- és Stokes-tételek               |
| [[subjects/bigdata]]          | 61    | Big Data architektúrák és elemző módszerek: Hadoop (HDFS, YARN, MapReduce, Pig, Hive), Spark és Spark GraphX, Storm, gépi tanulási osztályozás/klaszterezés/dimenziócsökkentés, ajánlórendszerek, deep learning bevezetés |
...
Összesen 696 fogalomlap 14 tárgyban.
